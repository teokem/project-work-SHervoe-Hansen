...
For evaluation of the notebook we recommend the usage of Binder (using the provided link or shield) clearing all outputs and then run all cells for the display of Jupyter widgets.
